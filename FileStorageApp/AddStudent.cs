    ...
    public partial class AddStudent : MetroUserControl
    {
        ...
        private void mBtn_Click(object sender, EventArgs e)
        {
            ...
            if (isUserExist == false)
            {
                ...
                int adbms;
                if (!int.TryParse(mAdbms.Text, out adbms)){MetroMessageBox.Show(this, "ADBMS mark in not valid format");}
                ...
                if (adbms > 100 || ns > 100 || mc > 100 || an > 100 || se > 100)
                {
                    MessageBox.Show("Mark can not be more then 100");
                }
                else
                {
        ...
        private void mAdbms_Leave(object sender, EventArgs e)
        {
